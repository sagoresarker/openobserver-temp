...
describe("Header Component", () => {
  ...
  describe("Logo Rendering", () => {
    it("should display OpenObserve logo by default", async () => {
      ...
      const openobserveLogo = logoWrapper.find('.app-logo');
    ...
    it("should use dark theme logo when theme is dark", async () => {
      ...
      const openobserveLogo = darkWrapper.find('.app-logo');
      expect(openobserveLogo.exists()).toBe(true);
    ...
    it("should not display OpenObserve logo when custom_hide_self_logo is true", async () => {
      ...
      const openobserveLogo = customWrapper.find('.app-logo');
  ...
  describe("User Profile", () => {
    ...
    it("should accept optional langList and selectedLanguage (app is English only)", () => {
      expect(wrapper.props("langList")).toBeDefined();
  ...
  describe("Theme Management", () => {
    it("should render with light theme logo", async () => {
      ...
      const logo = lightWrapper.find('.app-logo');
    ...
    it("should render with dark theme logo", async () => {
      ...
      const logo = darkWrapper.find('.app-logo');
      expect(logo.exists()).toBe(true);
  ...
  describe("Edge Cases", () => {
    ...
    it("should render default Sherlock logo when both custom logos are null", () => {
      const wrapper = createWrapper({
        mountType: 'mount',
        storeOverrides: {
          state: {
      ...
      expect(imgs[0].attributes('src')).toContain('sherlock');
    });
