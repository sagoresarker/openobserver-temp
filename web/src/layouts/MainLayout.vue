...
export default defineComponent({
  ...
  setup() {
    ...
    // Platform UI (simplified nav) is on by default. Set VITE_PLATFORM_UI=false in .env to use full nav.
    const isSimplifiedNav = () =>
      store.state.zoConfig?.simplified_nav === true ||
      store.state.zoConfig?.platform_ui === true ||
