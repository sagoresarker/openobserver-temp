            ...
            >
              <template v-if="showFunctionEditor">
                <div class="tw:relative tw:h-full tw:w-full">
                  <div
                    class="query-editor-wrap tw:border tw:solid tw:border-[var(--o2-border-color)] tw:mr-[0.375rem] tw:mb-[0.375rem] tw:rounded-[0.375rem] tw:overflow-hidden tw:h-full"
                  >
                    <code-query-editor
                      v-if="router.currentRoute.value.name === 'logs'"
                      data-test="logs-vrl-function-editor"
